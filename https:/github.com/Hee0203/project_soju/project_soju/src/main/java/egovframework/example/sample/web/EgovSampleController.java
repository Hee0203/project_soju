...
public class EgovSampleController {
	...
	public String drink_api(HttpServletRequest request) throws Exception {
        ...
        urlBuilder.append("?" + "pageNo=1"); /*미 입력 시 기본값으로 실행*/
        urlBuilder.append("&" + "numOfRows=30"); /*미 입력 시 기본값으로 실행*/
        //urlBuilder.append("&" +  "centerNm="+URLEncoder.encode("국립암센터","UTF-8")); /*대상 센터 명*/
        urlBuilder.append("&" + "fromYear=2021"); /*조회 기준 시작 연도*/
        urlBuilder.append("&" + "toYear=2021"); /*조회 기준 종료 연도*/
        urlBuilder.append("&" + "type=json"); /*리턴 타입을 JSON으로 받고 싶은 경우 json으로 변경*/
